...
import { loginBasic, verifyCaptcha } from "@/service/AuthenticationService";
import { toast } from "react-toastify"; // Import toast để hiển thị thông báo
import "react-toastify/dist/ReactToastify.css"; // Import CSS của toastify
import { ToastContainer } from "react-toastify";
import { CaptchaConfig, FacebookConfig, OAuthConfig } from "@/config/config";
...
export default function LoginPage() {
  ...
  const handleLogin = async () => {
    ...
    try {
      setLoading(true);
      const response = await loginBasic({ email, password });
