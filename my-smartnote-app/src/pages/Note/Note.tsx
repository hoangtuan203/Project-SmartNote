            ...
            favorites.map((note) => (
              ...
              >
                ...
                <p
                  ...
                  style={{
                    height: "150px", // Chiều cao cố định, bạn có thể điều chỉnh giá trị này
                    overflow: "hidden", // Ẩn bớt nội dung vượt quá chiều cao
                    textOverflow: "ellipsis", // Thêm dấu "..." khi nội dung quá dài
                    display: "webkit-box",
                    WebkitBoxOrient: "vertical",
                    WebkitLineClamp: 5, // Giới hạn số dòng nếu cần
                  }}
